...
$(function () {
    ...
    /**压缩x轴显示的标签数量**/
     var xLen = x_arr.length,
            maxLabelNum = 6, //x轴上最多显示的label个数，过多就会挤在一起
 ...
 marginTop:30,
            ...
            xAxis: {
/*                 type:"datetime", */
                categories:x_arr,     /**刻度集合**/ 
                /* tickInterval:1000*60, */  /**数据刻度 1分钟  每60s请求一次数据**/
                max:240,   /**以每分钟取一次记录算，股市交易时间一共241个点**/
                min:0,
                tickPixelInterval:200,   /**坐标密度**/
                tickInterval: step,
